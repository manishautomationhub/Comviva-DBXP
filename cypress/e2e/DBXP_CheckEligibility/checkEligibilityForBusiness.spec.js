...
describe('DBXP CheckEligibility ',()=> {
    ...
    it('Validate Check Eligibility For Business',()=> {
...
onEmploymentTypePage.chooseEmploymentType('Business')
onEmploymentTypePage.enterDataForBusinessOwner(checkEligibility.StartDateOfBusiness,checkEligibility.CompanyName,checkEligibility.LastYearPAT)
