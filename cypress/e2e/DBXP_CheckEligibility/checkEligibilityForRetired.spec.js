...
describe('DBXP CheckEligibility ',()=> {
    ...
    it('Validate Check Eligibility For Retired',()=> {
...
onEmploymentTypePage.chooseEmploymentType('Retired')
onEmploymentTypePage.enterDataForRetired(checkEligibility.LastEmployer)
